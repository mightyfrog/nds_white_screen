...
- **Real Hardware**: Copy `nds_white_screen.nds` to your DS flashcard (for example, DSpico) and run it on real hardware. Use the console's physical brightness controls (Select + brightness button on DS Lite) to set the backlight to maximum.
